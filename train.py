...
def parse_option():
    ...
    # training
    parser.add_argument('--epochs', type=int, default=2, help='epoch number')
...
def build_loader(opt):
    ...
    image_root = os.path.join(opt.data_dir, 'C:\\Users\\Asus\\Desktop\\RD3D-master\\NJU2K\\jpg')
    gt_root = os.path.join(opt.data_dir, 'C:\\Users\\Asus\\Desktop\\RD3D-master\\NJU2K\\png')
    depth_root = os.path.join(opt.data_dir, 'C:\\Users\\Asus\\Desktop\\RD3D-master\\NJU2K\\bmp')
