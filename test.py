...
parser.add_argument('--model_path', type=str, default= 'C:\\Users\\Asus\\Desktop\\RD3D-master\\output\\1654673756\\I3D_edge_last_ckpt.pth' , help='path to model file')
...
for dataset in test_datasets:
    ...
    image_root = os.path.join(dataset_path, dataset, 'C:\\Users\\Asus\\Desktop\\RD3D-master\\NLPR\\jpg\\')
    gt_root = os.path.join(dataset_path, dataset, 'C:\\Users\\Asus\\Desktop\\RD3D-master\\NLPR\\png\\')
    depth_root = os.path.join(dataset_path, dataset, 'C:\\Users\\Asus\\Desktop\\RD3D-master\\NLPR\\bmp\\')
